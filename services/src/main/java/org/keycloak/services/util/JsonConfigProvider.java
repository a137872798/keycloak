...
public class JsonConfigProvider implements Config.ConfigProvider {
    ...
    public String getProvider(String spi) {
        ...
        return n != null ? this.replaceProperties(n.textValue()) : this.fallback.getProvider(spi);
    }

    public Config.Scope scope(String... path) {
        JsonNode n = getNode(this.config, path);
        return n != null ? new JsonScope(n) : this.fallback.scope(path);
    }
